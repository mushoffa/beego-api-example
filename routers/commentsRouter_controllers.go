...
func init() {
    ...
    beego.GlobalControllerRouter["beego-api-example/controllers:SeedController"] = append(beego.GlobalControllerRouter["beego-api-example/controllers:SeedController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
    ...
    beego.GlobalControllerRouter["beego-api-example/controllers:UserController"] = append(beego.GlobalControllerRouter["beego-api-example/controllers:UserController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
